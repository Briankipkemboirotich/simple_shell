...
#include <sys/wait.h>
#include <unistd.h>
#include "./_string/string.h"
#include "./_linklist/linklist.h"
#include "./_memo/memo.h"
#include "shellvar.h"
#include "./_builtin/builtin.h"
#include "./_error/error.h"
#include "./_shelp/shelp.h"
#include "./_log/log.h"
#define SPACE " "
#define EQUAL "="
#define COLON ":"
...
#define PS1 write(STDOUT_FILENO, "Bkr$ ", 4)
